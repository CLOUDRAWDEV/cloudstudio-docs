...
자격증명이 없는 경우 [**자격증명등록**](https://docs.cstudio.app/docs/credential/create-credential#azure-%ED%81%AC%EB%A0%88%EB%8D%B4%EC%85%9C-%EB%93%B1%EB%A1%9D%ED%95%98%EA%B8%B0) 페이지를 확인해주시기 바랍니다.
