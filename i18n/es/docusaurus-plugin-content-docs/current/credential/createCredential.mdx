...
<br />
11. En la barra lateral izquierda, haz clic en `Certificados y secretos`. 12.
Haz clic en `Nuevo secreto de cliente`. 13. Introduce una breve descripción para
la Key y selecciona el período de expiración. Una vez completado, haz clic en
`Agregar`. 14. Copia el valor generado y pégalo en `Service Principal Key` de
Cloud Studio.
