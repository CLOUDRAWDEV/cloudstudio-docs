---
title: Security Inspection Overview
sidebar_position: 1
tags: [security, Security Inspection, canvas]
---
...
<hr />
<br />
Security inspection is a feature that examines the cloud infrastructure drawn on
...
1. `Save` the canvas.
2. Click on `Tools > Vulnerability Inspection`.
3. Check the `Inspection Score Results` in the detailed results.
...
7. Close the security inspection window and make the necessary adjustments on the canvas.
