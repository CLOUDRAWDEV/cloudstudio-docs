...
You can run server workloads by configuring VM size (SKU), operating system image, authentication method (password/SSH key), disk configuration, network interface connections, and Cloud-init initialization scripts.
