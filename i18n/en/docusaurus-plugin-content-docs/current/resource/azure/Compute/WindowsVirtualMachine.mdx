...
By running Windows Server virtual machines in Azure, users can leverage the scalability, reliability, and global reach of the Microsoft cloud platform.
...
-   `os_disk_caching` : Caching type for the OS Disk
...
-   `disk_size_gb` : Size of the OS Disk (GB)
