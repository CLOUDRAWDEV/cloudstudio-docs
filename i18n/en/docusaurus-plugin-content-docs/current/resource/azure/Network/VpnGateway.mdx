...
By configuring connections with VpnSite resources, it establishes Site-to-Site VPN tunnels and allows fine-grained control over security policies and encryption options.
...
-   `connection.link_names.sa_data_size_kb` : Maximum Security Association data size (KB)
