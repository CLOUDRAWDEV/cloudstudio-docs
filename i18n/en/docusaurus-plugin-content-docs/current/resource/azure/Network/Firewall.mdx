...
It supports L3–L7 level filtering through Network, Application, and NAT rules, and is commonly used as a shared security boundary in hub-and-spoke or single VNet architectures.
...
-   `included_subnet_name` : Name of the Subnet where the Firewall will be deployed
-   `linked_firewall_subnet_public_ip_name` : Name of the Public IP to associate with the Firewall Subnet
...
-   `linked_firewall_management_subnet_public_ip_name` : Name of the Public IP to associate with the Firewall Management Subnet
