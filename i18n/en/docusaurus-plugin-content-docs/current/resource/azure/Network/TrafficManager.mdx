...
-   `relative_domain_name` : Domain name to be used by Traffic Manager
...
-   `azure_endpoint.linked_resource_type` : Type of Azure endpoint
...
-   `nested_endpoint.min_child_endpoints` : Minimum number of online endpoints required for traffic routing
