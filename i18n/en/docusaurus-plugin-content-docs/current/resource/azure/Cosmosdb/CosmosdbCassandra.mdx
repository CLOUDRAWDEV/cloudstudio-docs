...
-   `public_network_access_enabled` : Whether to allow account access via the public network
...
-   `cassandra_keyspace.enable_autoscale` : Whether to enable automatic throughput scaling
...
-   `cassandra_table.enable_autoscale` : Whether to enable automatic table throughput scaling
-   `cassandra_table.included_cosmosdb_keyspace_name` : Name of the Cassandra keyspace in which the table is created
