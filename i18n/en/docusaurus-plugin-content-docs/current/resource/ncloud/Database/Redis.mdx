...
Cloud DB for Redis is a fully managed cloud cache service that allows you to easily build Redis caches with just a few settings and clicks, operates stably with Naver’s optimized settings, and automatically recovers in case of failures.
